-- Fichier : db/migrations/001_refonte_soldes.sql
-- VERSION FINALE HARMONISÉE

PRAGMA foreign_keys=ON;
BEGIN TRANSACTION;

-- Création de la table agents avec la terminologie finale 'cadre'
CREATE TABLE IF NOT EXISTS agents (
    id INTEGER PRIMARY KEY, 
    nom TEXT NOT NULL, 
    prenom TEXT, 
    ppr TEXT UNIQUE NOT NULL, 
    cadre TEXT NOT NULL -- Modifié de 'grade' à 'cadre'
);
